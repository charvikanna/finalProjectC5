  ...
  var body: some View {
    NavigationStack {
      ZStack {
        ...
        Text("Maternal Mortality").font(.title2).fontWeight(.bold).foregroundColor(Color.black).position(x:143, y:230)
        Text("Racial Inequalities in Healthcaure").font(.caption).fontWeight(.medium).foregroundColor(Color.black).padding().position(x:145, y:250)
        VStack {
